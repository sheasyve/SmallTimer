...
class TimerApp:
    def __init__(self, root):
        ...
        self.hours = ttk.Entry(self.time_frame, textvariable=self.hours_var, font=("Arial", 48),
                               width=2, justify='center', validate='key', validatecommand=vcmd)
        ...
        self.colon1 = tk.Label(self.time_frame, text=":", font=("Arial", 48),
                               fg='white', bg='#353535')
        self.colon1.grid(row=0, column=1, sticky='ns')

        self.minutes = ttk.Entry(self.time_frame, textvariable=self.minutes_var, font=("Arial", 48),
                                 width=2, justify='center', validate='key', validatecommand=vcmd)
        ...
        self.colon2 = tk.Label(self.time_frame, text=":", font=("Arial", 48),
                               fg='white', bg='#353535')
        self.colon2.grid(row=0, column=3, sticky='ns')

        self.seconds = ttk.Entry(self.time_frame, textvariable=self.seconds_var, font=("Arial", 48),
                                 width=2, justify='center', validate='key', validatecommand=vcmd)
    ...
    def show_notification(self):
        ...
        self.stop_sound()
        self.start_button.grid(row=0, column=0, sticky='nsew')
        self.reset_button.grid_configure(column=1, columnspan=1, sticky='nsew')
            ...
            try:
                ...
                if self.time_in_seconds > 0:
                    ...
                    self.time_label = tk.Label(self.time_frame,
                                               ...
                                               font=("Arial", 48), fg='white', bg='#353535')
                    self.time_label.grid(row=0, column=0, columnspan=5, sticky='nsew')
                    for i in range(5):
                        self.time_frame.columnconfigure(i, weight=0)
                    self.time_frame.columnconfigure(0, weight=1)
                    self.running = True
                    self.start_button.grid_remove()
                    self.reset_button.grid_configure(column=0, columnspan=2, sticky='nsew')
                    self.update_timer()
                else:
...
#Sound source Alarm Bell by SergeQuadrado -- https://freesound.org/s/460262/ -- License: Attribution NonCommercial 3.0
